...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accordion_presentation_accordion', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('custom_classes', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal(u'accordion_presentation', ['Accordion'])


    def backwards(self, orm):
        # Deleting model 'Accordion'
        db.delete_table(u'accordion_presentation_accordion')


    models = {
        u'accordion_presentation.accordion': {
            'Meta': {'object_name': 'Accordion', '_ormbases': ['cms.CMSPlugin']},
